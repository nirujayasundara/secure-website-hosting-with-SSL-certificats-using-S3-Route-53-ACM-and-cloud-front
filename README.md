...
go to the route 53 and creat hosted zone. enter the domaaaain name, select public hosted tone and create hosted zone.
...
once it sucess go to route 53 and copy the record name and using that you can loard the secure website. in my case it is   niroshajayasundaracloudresumechallenge.site
